...
def train():
    ...
    stop = {
        # "training_iteration": args.stop_iters,
        "timesteps_total": 5000_0000,
        "episode_reward_mean": 200,
    }

    tuner = tune.Tuner(
        "AlphaZero", param_space=config, run_config=air.RunConfig(stop=stop, verbose=2,local_dir = "./ray_results")
    )
...
def test():
    checkpoint_path = r"D:\rl\backtrader\example\gym\ray_results\PPO\PPO_TradingEnv2_c32ac_00000_0_2023-09-05_17-08-22\checkpoint_012500"
